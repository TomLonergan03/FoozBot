...
def detect_and_draw_lines(frame):
    ...
    # Print x and y coordinates of pink points
    for contour in contours:
        # Extract pink points (contour points)
        pink_points = contour.reshape(-1, 2)

        # Iterate over all pink points and print coordinates
        for point in pink_points:
            x, y = point
            print(f"Pink Point Coordinates: ({x}, {y})")

            # Draw a small circle at the pink point
